...
- Made some small UI tweaks to the extension:
  - Added a generalized loading state
  - Increased the maximum height of the extension UI
  - Updated the error page to apply more granularly
